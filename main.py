...
def main():
    ...
    print('\n' + '=' * 50)
    print('STEP 2: BASE AND ADVANCED FEATURE ENGINEERING')
    print('=' * 50)
    df = create_base_features(df)
    df = create_advanced_features(df)
    print('\nBase and advanced features created successfully')
    ...
    print('\n' + '=' * 50)
    print('STEP 5: SPLITTING AND SCALING FEATURES')
    print('=' * 50)
    ...
    print('\n' + '=' * 50)
    print('STEP 6: FAST MODEL EVALUATION')
    print('=' * 50)
    run_fast_model_evaluation(x_train, x_test, y_train, y_test)

    print('\n' + '=' * 50)
    print('STEP 7: TRAINING AND HYPERPARAMETER OPTIMIZATION')
    print('=' * 50)
    best_models = train_and_optimize_models(x_train_scaled, y_train)

    print('\n' + '=' * 50)
    print('STEP 8: SAVING TRAINED MODEL ARTIFACTS')
    print('=' * 50)
    ...
    print('\n' + '=' * 50)
    print('STEP 11: PAYMENT TYPE INSIGHTS')
    print('=' * 50)
